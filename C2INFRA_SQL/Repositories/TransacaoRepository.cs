    ...
    public class TransacaoRepository : ITransacaoRepository
    {
        ...
        public List<TransacaoCustomEntity> ListarCustom()
        {
            using (var db = _context.DapperConexao())
            {
                ...
                query.Append(" SELECT t.Id, t.GuidId, t.TransacaoStatus, t.TransacaoDataCadastro, t.DataAtualizacao, t.Empresa_Id, t.Mes, t.Ano, e.Nome as EmpresaNome FROM Transacao as t");
